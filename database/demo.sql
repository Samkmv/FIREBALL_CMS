...
SELECT 'Демо-запись FIREBALL CMS', 'demo-post', 'Москва', id, 'Одна демонстрационная запись для проверки блога.', '<p>Это демонстрационная запись FIREBALL CMS.</p>', '', 'Демо-запись FIREBALL CMS', 'Одна демонстрационная запись FIREBALL CMS.', 'fireball cms, demo, post', '', 0, 1, 10, 1, 'Creator', 'creator', 0, :now, 1
