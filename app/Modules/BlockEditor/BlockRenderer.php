...
final class BlockRenderer
{
    ...
    private function gallery(array $data, string $type): string
    {
        ...
        // FIREBALL_GALLERY_GRID_SLIDER_SWIPER_V2
        // gallery -> Cartzilla grid + GLightbox
        // slider  -> Cartzilla/Swiper fade slider
        $images = [];
        ...
        static $sliderSequence = 0;
        $sliderSequence++;

        $baseId = 'fb-block-slider-' . $sliderSequence;
