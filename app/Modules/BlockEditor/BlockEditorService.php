...
final class BlockEditorService
{
    ...
    protected function labels(): array
    {
        ...
        $labels += [
            ...
            'galleryFromManager' => $this->translateOrFallback('editor_gallery_from_manager', 'Choose from file manager'),
            'galleryFromComputer' => $this->translateOrFallback('editor_gallery_from_computer', 'Upload from computer'),
            'galleryFromUrl' => $this->translateOrFallback('editor_gallery_from_url', 'Add from URL'),
            'galleryUrlPlaceholder' => $this->translateOrFallback('editor_gallery_url_placeholder', 'https://example.com/image.jpg'),
            'galleryUrlHint' => $this->translateOrFallback('editor_gallery_url_hint', 'External images are referenced by URL and are not copied to local storage.'),
            'galleryInvalidUrl' => $this->translateOrFallback('editor_gallery_invalid_url', 'Enter a valid http:// or https:// image URL.'),
            'galleryUploading' => $this->translateOrFallback('editor_gallery_uploading', 'Uploading…'),
            'galleryUploadFailed' => $this->translateOrFallback('editor_gallery_upload_failed', 'Image upload failed.'),
