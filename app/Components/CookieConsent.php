...
class CookieConsent
{
    ...
    public function render(): string
    {
        ...
        <style>
            ...
            .fireball-cookie-consent__inner{height:auto;max-height:none;overflow:visible;padding:18px 20px;border:1px solid rgba(128,128,128,.25);border-radius:20px;background:var(--bs-body-bg,#fff);background:color-mix(in srgb,var(--bs-body-bg,#fff) 88%,transparent);box-shadow:0 18px 55px rgba(15,23,42,.18);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}
            .fireball-cookie-consent--bar .fireball-cookie-consent__inner{width:100%;border-radius:0;padding:14px max(20px,env(safe-area-inset-right)) max(14px,env(safe-area-inset-bottom)) max(20px,env(safe-area-inset-left))}
            .fireball-cookie-consent__message{max-width:760px;margin:0}
            .fireball-cookie-consent--bar .fireball-cookie-consent__message{margin-right:auto;margin-left:auto;text-align:center}
            .fireball-cookie-consent__actions{display:flex;align-items:center;flex-wrap:wrap;gap:10px;margin-top:12px}
            .fireball-cookie-consent--bar .fireball-cookie-consent__actions{justify-content:center}
            ...
            @media(max-width:767.98px){.fireball-cookie-consent{font-size:14px;line-height:1.35}.fireball-cookie-consent--card{width:calc(100vw - 24px)}.fireball-cookie-consent--bottom-right{right:12px;bottom:max(12px,env(safe-area-inset-bottom))}.fireball-cookie-consent--bottom-left{left:12px;bottom:max(12px,env(safe-area-inset-bottom))}.fireball-cookie-consent__inner{padding:14px;border-radius:16px}.fireball-cookie-consent__actions{align-items:stretch;flex-direction:column;gap:8px;margin-top:10px}.fireball-cookie-consent__actions>*{width:100%;flex:0 0 auto}.fireball-cookie-consent--bar .fireball-cookie-consent__inner{padding:9px max(12px,env(safe-area-inset-right)) max(9px,env(safe-area-inset-bottom)) max(12px,env(safe-area-inset-left))}.fireball-cookie-consent--bar .fireball-cookie-consent__message{text-align:left}.fireball-cookie-consent--bar .fireball-cookie-consent__actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:7px}.fireball-cookie-consent--bar .fireball-cookie-consent__actions>*{width:100%;min-height:36px;padding:7px 12px;font-size:13px}}
