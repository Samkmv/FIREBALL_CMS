...
<main class="content-wrapper">
    ...
    <section class="container pb-5 mb-1 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
        ...
        <div class="row">
            <aside class="col-lg-4 order-lg-2 pb-3 mb-3 mb-md-4" style="margin-top: -115px">
            ...
            <article class="col-lg-8 order-lg-1">
                ...
                <div class="d-flex gap-3 pb-3 mb-4">
                ...
                <div class="border rounded-4 p-4">
                    <div class="d-sm-flex align-items-center justify-content-between text-center text-sm-start p-md-3">
                        ...
                        <a class="btn btn-lg btn-primary" href="<?= base_href('/support#support-question-form') ?>"><?= print_translation('support_contact_button') ?></a>
                    </div>
                </div>
            </article>
        </div>
