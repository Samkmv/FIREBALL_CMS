<div style="font-family: Arial, sans-serif; color: #222; line-height: 1.6;">
    <h2 style="margin-bottom: 16px;"><?= htmlSC(return_translation('auth_two_factor_recovery_email_heading')) ?></h2>
    <p><?= htmlSC(return_translation('auth_two_factor_recovery_email_text')) ?></p>
    <p>
        <a href="<?= htmlSC($reset_url ?? '') ?>" style="display: inline-block; padding: 12px 20px; background: #222; color: #fff; text-decoration: none; border-radius: 999px;">
            <?= htmlSC(return_translation('auth_two_factor_recovery_email_button')) ?>
        </a>
    </p>
