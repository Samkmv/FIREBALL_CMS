...
$pageTitle = $title ?? return_translation('error_403_title');
$message = trim((string)($error ?? '')) !== '' ? (string)$error : return_translation('error_403_message');
?>
...
<main class="content-wrapper d-flex align-items-center justify-content-center">
    <div class="container">
        ...
        <section class="text-center py-5 px-2 px-sm-0 my-2 my-md-3 my-lg-4 my-xl-5 mx-auto" style="max-width: 636px">
            ...
            <h1><?= print_translation('error_403_heading') ?></h1>
