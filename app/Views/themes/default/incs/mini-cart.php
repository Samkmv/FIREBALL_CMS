<?php if ($cart = \App\Helpers\Cart\Cart::getCart()): ?>
    ...
    <div class="offcanvas-header flex-column align-items-start">
        ...
        <div class="d-flex w-100 gap-3">
            <a class="btn btn-lg btn-secondary w-100 rounded-pill" href=""><?= _e('tpl_menu_btn_cart_details') ?></a>
            <a class="btn btn-lg btn-primary w-100 rounded-pill" href=""><?= _e('tpl_menu_btn_cart_buy') ?></a>
        </div>
    </div>
...
<?php else: ?>
    ...
    <div class="offcanvas-body text-center">
        ...
        <h6 class="mb-2"><?= _e('tpl_menu_cart_title') ?></h6>
        <p class="fs-sm mb-4"><?= _e('tpl_menu_cart_desc') ?></p>
    </div>
