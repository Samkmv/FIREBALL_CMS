<?php if ($cart = \App\Helpers\Cart\Cart::getCart()): ?>
    ...
    <div class="offcanvas-header flex-column align-items-start">
        ...
        <div class="d-flex w-100 gap-3">
            <a class="btn btn-lg btn-secondary w-100 rounded-pill" href="">Подробнее</a>
            <a class="btn btn-lg btn-primary w-100 rounded-pill" href="">Купить</a>
        </div>
    </div>
...
<?php else: ?>
    ...
    <div class="offcanvas-body text-center">
        ...
        <h6 class="mb-2">В данный момент ваша корзина пуста!</h6>
        <p class="fs-sm mb-4">Ознакомьтесь с нашим широким ассортиментом и добавьте товары в корзину, чтобы продолжить покупку.</p>
    </div>
