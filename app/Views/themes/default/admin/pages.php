...
<?= view()->renderPartial('admin/shell_open', [
    ...
    <div class="border rounded-5 p-3 p-md-4 admin-table-card" data-admin-table data-ajax-table="pages" data-ajax-table-format="json" data-admin-posts-tabs="pages">
        <form method="get" action="<?= htmlSC(base_href('/admin/pages')) ?>" class="position-relative mb-3" style="max-width: 320px" data-admin-table-form>
