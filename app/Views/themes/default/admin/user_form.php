        ...
        <form id="userForm" action="<?= $formAction ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select <?= get_validation_class('role') ?>" name="role" data-select aria-label="<?= htmlSC(return_translation('admin_users_col_role')) ?>" <?= $isProtectedCreator ? 'disabled' : '' ?> required>
