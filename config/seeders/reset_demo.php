...
$insertUsers = static function (string $now): void {
    $users = [
        ['Creator', 'creator', 'creator@admin.com', 'creator', 'creator'],
        ['Administrator', 'admin', 'admin@admin.com', 'admin', 'admin'],
        ['Moderator', 'moderator', 'moderator@example.com', 'moderator', 'moderator'],
        ['Demo User', 'user', 'user@example.com', 'user', 'user'],
    ];
...
$insertSiteSettings = static function (string $now): void {
    $settings = [
        ...
        'site_description' => 'Демо-установка FIREBALL CMS с одной категорией и одной записью.',
        'seo_home_title' => 'FIREBALL CMS',
        'seo_default_title_suffix' => ' | FIREBALL CMS',
        'seo_meta_description' => 'Демо-установка FIREBALL CMS с одной категорией и одной записью.',
...
$insertDemoPost = static function (string $now): array {
    db()->query(
    ...
    $content = '<p>Это единственная демо-запись после сброса базы. Ее можно редактировать, скрывать блоки и проверять публикацию.</p>';
...
$insertMetrics($now);
$demoData = $insertDemoPost($now);

return array_merge([
    'status' => 'ok',
    'message' => 'Database cleared. Demo users and content created.',
    'accounts' => [
        ['role' => 'creator', 'login' => 'creator', 'email' => 'creator@admin.com', 'password' => 'creator'],
        ['role' => 'admin', 'login' => 'admin', 'email' => 'admin@admin.com', 'password' => 'admin'],
        ['role' => 'moderator', 'login' => 'moderator', 'email' => 'moderator@example.com', 'password' => 'moderator'],
        ['role' => 'user', 'login' => 'user', 'email' => 'user@example.com', 'password' => 'user'],
    ],
], $demoData);
