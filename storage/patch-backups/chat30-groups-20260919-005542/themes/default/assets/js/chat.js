$(function () {
    ...
    chatApp.on('click', '[data-chat-reaction-open]', function (event) {
        ...
        const picker = chatApp.find(`[data-chat-reaction-picker][data-message-id="${messageId}"]`).first();
        const wasHidden = picker.hasClass('d-none');
        closeReactionPickers(messageId);
        picker.toggleClass('d-none', !wasHidden);
    });
