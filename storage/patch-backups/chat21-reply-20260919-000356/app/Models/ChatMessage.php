    ...
    public function create(int $senderId, int $receiverId, string $message, ?array $attachment = null, array $meta = []): int
    {
        ...
        db()->query(
            "INSERT INTO {$this->table}
             ...
             VALUES (:conversation_id, :sender_id, :receiver_id, :message_ciphertext, :encryption_key_id, :attachment_path, :attachment_name, :attachment_type, :attachment_size, :sender_ip, :sender_user_agent, :is_read, NULL, NULL, NULL, NULL, NULL, NULL, :created_at)",
            [
