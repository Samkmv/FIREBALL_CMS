...
<?= view()->renderPartial('admin/shell_open', [
    ...
    <div class="vstack gap-3">
        ...
        <section class="border rounded-5 p-3 p-md-4" id="wireguard">
            ...
            <h3 class="h6 mt-3">Ручное безопасное применение на сервере</h3>
            <p class="small text-body-secondary">Команды сначала создают резервную копию. <code>wg set</code> меняет только работающий interface; peer-блок в <code>wg0.conf</code> администратор добавляет вручную перед <code>wg syncconf</code>.</p>
            <?= $copyBlock('camera-wireguard-commands', (string)($network['wireguard_commands'] ?? '')) ?>
